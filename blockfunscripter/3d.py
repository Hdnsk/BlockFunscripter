...
#     Property, QCoreApplication, QObject, QPropertyAnimation, Signal, Qt)
# from PySide2.QtGui import (
#     QGuiApplication, QMatrix4x4, QQuaternion, QVector3D, QColor)
...
#         self.material.setAmbient(QColor(114, 168, 212, 255))
#         self.material.setDiffuse(QColor(114, 168, 212, 255))
#         self.material.setSpecular(QColor(198, 13, 212, 255))
...
#         # self.lightRepr = Qt3DExtras.QSphereMesh()
#         # self.lightRepr.setRadius(0.3)
#         self.lightSource = Qt3DRender.QPointLight()
#         self.lightSource.setColor("red")
#         self.lightSource.setIntensity(2)

#         self.lightTransform = Qt3DCore.QTransform()
#         self.lightTransform.setTranslation(QVector3D(15, 15, 15))

#         self.lightEntity.addComponent(self.lightSource)
#         self.lightEntity.addComponent(self.lightTransform)
#         # self.lightEntity.addComponent(self.lightRepr)
#         self.lightEntity.addComponent(self.material)
...
#         self.cylinderMesh.setLength(14)

#         self.attEnt = Qt3DCore.QEntity(self.cylinderEntity)
#         self.attleft = Qt3DExtras.QSphereMesh()
#         self.lightRepr.setRadius(0.1)
